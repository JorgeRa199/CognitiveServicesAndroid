...
public class AnalyzeInDomainActivity extends AppCompatActivity {
    ...
    public void selectImage(View view) {
        ...
        Intent intent;
        intent = new Intent(AnalyzeInDomainActivity.this, com.example.examenchido2.SelectImageActivity.class);
